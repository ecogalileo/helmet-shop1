        ...
        if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
            ...
            if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
                if ($fsize >= 1000000) {
                    ...
                    $sql = "INSERT INTO style(rs_id,title,slogan,price,img) VALUE('" . $_POST['res_name'] . "','" . $_POST['d_name'] . "','" . $_POST['about'] . "','" . $_POST['price'] . "','" . $fnew . "')";  // store the submited data ino the database :images
                    mysqli_query($db, $sql);
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            ...
                            <div class="form-actions">
                                ...
                                <a href="add_style.php" class="btn btn-inverse">Cancel</a>
                            </div>
                            </form>
                        </div>
