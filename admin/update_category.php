...
$sql = "update categories set title='$res_name', address='$_POST[address]', image='$fnew' where rs_id='$_GET[res_upd]' "; // store the submited data ino the database :images mysqli_query($db, $sql);
mysqli_query($db, $sql);
...
<head>
    ...
    <title>Update Helmet Categories</title>
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        ...
                        <h4 class="m-b-0 ">Update Helmet Category</h4>
                            ...
                            <form action='' method='post' enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Helmet Category Name</label>
