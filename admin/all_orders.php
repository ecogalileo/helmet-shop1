            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Helmet Styles</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="all_style.php">All Style</a></li>
                                <li><a href="add_style.php">Add Style</a></li>
                            </ul>
                        </li>
