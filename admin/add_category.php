    ...
    if (empty($_POST['res_name']) || $_POST['address'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO categories(title,address,image) VALUE('" . $res_name . "','" . $_POST['address'] . "','" . $fnew . "')";  // store the submited data ino the database :images
                mysqli_query($db, $sql);
...
<head>
    ...
    <title>Add Helmet Categories</title>
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">Add Helmet Category</h4>
                        </div>
                        <div class="card-body">
