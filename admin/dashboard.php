...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                                ...
                                <div class="card p-30">
                                    <div class="media">
                                        <div class="media-left meida media-middle">
                                            <span><i class="fa fa-th-list f-s-40 "></i></span>
                                        </div>
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from categories";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                            <p class="m-b-0">Helmet Category</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="card p-30">
                                    <div class="media">
                                        <div class="media-left meida media-middle">
                                            <span>
                                                <i class="fa fa-motorcycle f-s-40" aria-hidden="true"></i>
                                            </span>
                                        </div>
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from style";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                            <p class="m-b-0">Helmet Styles</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- <script src="https://kit.fontawesome.com/573cf7eb09.js" crossorigin="anonymous"></script> -->
