...
<head>
    ...
    <link rel="icon" href="#">
    <title>Helmets || Armor T3ch</title>
    <link rel="icon" type="image/x-icon" href="images/logo-helmet.png">
        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="helmets.php">Choose Helmet Category</a></li>
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="style.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite style</a></li>
                    <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Order and Pay</a></li>

                </ul>
            </div>
        </div>
        <?php $ress= mysqli_query($db,"select * from categories where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
        <section class="inner-page-hero bg-image" data-image-src="images/helmets/244580096_996486740916633_4433670621782426374_n.jpg">
            <div class="profile">
                <div class="container">
                    <div class="row">
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="order-row bg-white">
                            <div class="widget-body">
                                ...
                                <div class="title-row">
                                    <?php echo $item["title"]; ?><a href="style.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>">
                ...
                <div class="col-md-8">
                    ...
                    <div class="menu-widget" id="2">
                        ...
                        <div class="collapse in" id="popular2">
                            <?php  
									$stmt = $db->prepare("select * from style where rs_id='$_GET[res_id]'");
									$stmt->execute();
                            ...
                            <div class="food-item">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-lg-8">
                                        <form method="post" action='style.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/style/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
