...
<head>
    ...
    <link rel="icon" href="#">
    <title>My Orders || Armor T3ch</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="inner-page-hero bg-image" data-image-src="images/helmets/244580096_996486740916633_4433670621782426374_n.jpg">
                    ...
                    <div class="col-xs-12">
                        <div class="bg-gray">
                            <div class="row">
                                ...
                                <table class="table table-bordered table-hover" style="margin-bottom: 25vh;">
